...
void coloring::brelaz_color(dyngraph& g) {	
		...
		// first.push_back(1); // every node has saturation degree 0
		//
		//
		//
		// do {
		...
		// 		assert(r<=order.size());
		// 		if(r<order.size()) {
		// 			assert(satur[order[r]].size == i);
		// 			if(r>1)
		// 				assert(satur[order[r-1]].size == i - 1);
		// 		}
		// 		++i;
		// 	}
		//
